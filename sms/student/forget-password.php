    ...
    <div class="form">
        ...
        <?php 
            ...
            if(isset($_POST['get-password']))
            {
                ...
                $query = mysqli_query($conn, "SELECT * FROM `student_info` WHERE student_number = '$number'");
                ...
                if($result['student_number'] == $number)
                {
                    ...
                    if($result['student_email'] == $email)
                    {
                        // it execute when dob is correct 
                        if($result['student_dob'] == $dob)
                        {
                            echo "Password is: ". "<b>" .$result['student_password']. "</b>";
                            exit();
                        }
                        else
                        {
