...
<body>
    ...
    <section class="dashboard-middle-area">
        ...
        <pre class="pagination"><p style="color: #1264a3;">Admin / </p> <p><a href="dashboard.php" style="color:#1264a3;">Dashboard</a> / </p> <a href="total-students.php">Total Students</a></pre> <hr>
        <div class="edit-detail-link pt-2">
            <span style="display: flex; width: 330px;">
                <i class='fa-solid fa-pen-to-square pe-2 pt-1'></i>
                <a href="manage-students.php" class="simple-edit-detail-link" style="color: #006bff">Edit Student Details</a>
                <a href="manage-students.php" class="responsive-edit-detail-link" style="display: none; color: #006bff">Edit Details</a>
            </span>
