        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <span class="signup-div">
                    <a href="student/signup.php"><button class="signup-btn"><i class="fa-duotone fa-solid fa-user me-2 fs-4" style="--fa-primary-color: #0d6ffd; --fa-secondary-color: #0d6ffd;"></i>Click here for Signup</button></a>
                </span>
            </div>
        </div>
    </nav>
                ...
                <div class="login-form-conatiner ps-3">
                    <form method="POST">
                        ...
                        <div class="inputs">
                            ...
                            <a href="student/signup.php" class="admin-link same-link">Not have an account?</a>
                            <a href="admin/login.php" class="login-link same-link">You are admin?</a>
                            <a href="student/forget-password.php" class="forget-password same-link">Forget Password?</a>
